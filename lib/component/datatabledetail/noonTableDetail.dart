...
class noonTableDetail extends StatefulWidget {
  const noonTableDetail({super.key});
  @override
  State<noonTableDetail> createState() => _noonTableDetailState();
}

class _noonTableDetailState extends State<noonTableDetail> {
  List<TableRow> _tableRows = [];
  void initState() {
    super.initState();
    DatabaseReference ref = FirebaseDatabase.instance.ref();

    ref.child('sensor/noon').onValue.listen((DatabaseEvent event) {
      if (event.snapshot.value != null) {
        final noonData = event.snapshot.value as Map<dynamic, dynamic>;
